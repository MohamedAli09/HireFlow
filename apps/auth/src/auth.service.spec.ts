...
describe('AuthService', () => {
    ...
    describe('register()', () => {
        ...
        it('returns success message when email is not taken', async () => {
            ...
            mockUserRepo.create.mockReturnValue({ email: 'a@a.com', password: 'hashed', role: Role.CANDIDATE });
            mockUserRepo.save.mockResolvedValue({});

            const result = await service.register({ email: 'a@a.com', password: 'secret123' });
        ...
        it('saves the user with the provided role when role is given', async () => {
            ...
            await service.register({ email: 'r@r.com', password: 'secret123', role: Role.RECRUITER });
    ...
    describe('login()', () => {
        ...
        it('throws UnauthorizedException when password is wrong', async () => {
            ...
            await expect(
                service.login('a@a.com', 'wrong-password')
            ).rejects.toThrow(UnauthorizedException);
        });
